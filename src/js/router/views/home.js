...
function setImageFallback(img, placeholder = PLACEHOLDER_VENUE) {
  img.onerror = () => {
    img.onerror = null
    img.src = placeholder
  }
  ...
  slice.forEach((venue) => {
    ...
    venueElement.innerHTML = `
      <div class="relative h-56 overflow-hidden group">
        <img src="${venue.media?.[0]?.url || PLACEHOLDER_VENUE}" 
    ...
    const imgEl = venueElement.querySelector("img")
    if (imgEl) setImageFallback(imgEl, PLACEHOLDER_VENUE)
  })
